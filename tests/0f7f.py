...
class TestSuite:
    def test(self):
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Opcode, 0xf7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'movq ')
        assert_equal(myDisasm.instr.repr, 'movq qword ptr [rax], mm4')
        ...
        assert_equal(myDisasm.instr.repr, 'movdqa xmmword ptr [rax], xmm4')
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqa ')
        assert_equal(myDisasm.instr.repr, 'vmovdqa xmmword ptr [r8], xmm12')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqa ')
        assert_equal(myDisasm.instr.repr, 'vmovdqa ymmword ptr [r8], ymm12')
        ...
        assert_equal(myDisasm.instr.repr, 'vmovdqa32 xmmword ptr [rax], xmm4')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqa32 ')
        assert_equal(myDisasm.instr.repr, 'vmovdqa32 ymmword ptr [rax], ymm4')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqa32 ')
        assert_equal(myDisasm.instr.repr, 'vmovdqa32 zmmword ptr [rax], zmm4')
        ...
        assert_equal(myDisasm.instr.repr, 'vmovdqa64 xmmword ptr [rax], xmm4')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqa64 ')
        assert_equal(myDisasm.instr.repr, 'vmovdqa64 ymmword ptr [rax], ymm4')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqa64 ')
        assert_equal(myDisasm.instr.repr, 'vmovdqa64 zmmword ptr [rax], zmm4')
        ...
        assert_equal(myDisasm.instr.repr, 'movdqu xmmword ptr [rax], xmm4')
        ...
        assert_equal(myDisasm.instr.repr, 'vmovdqu xmmword ptr [r8], xmm12')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqu ')
        assert_equal(myDisasm.instr.repr, 'vmovdqu ymmword ptr [r8], ymm12')
        ...
        assert_equal(myDisasm.instr.repr, 'vmovdqu32 xmmword ptr [rax], xmm4')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqu32 ')
        assert_equal(myDisasm.instr.repr, 'vmovdqu32 ymmword ptr [rax], ymm4')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqu32 ')
        assert_equal(myDisasm.instr.repr, 'vmovdqu32 zmmword ptr [rax], zmm4')
        ...
        assert_equal(myDisasm.instr.repr, 'vmovdqu64 xmmword ptr [rax], xmm4')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqu64 ')
        assert_equal(myDisasm.instr.repr, 'vmovdqu64 ymmword ptr [rax], ymm4')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqu64 ')
        assert_equal(myDisasm.instr.repr, 'vmovdqu64 zmmword ptr [rax], zmm4')
        ...
        assert_equal(myDisasm.instr.repr, 'vmovdqu8 xmmword ptr [rax], xmm4')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqu8 ')
        assert_equal(myDisasm.instr.repr, 'vmovdqu8 ymmword ptr [rax], ymm4')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqu8 ')
        assert_equal(myDisasm.instr.repr, 'vmovdqu8 zmmword ptr [rax], zmm4')
        ...
        assert_equal(myDisasm.instr.repr, 'vmovdqu16 xmmword ptr [rax], xmm4')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqu16 ')
        assert_equal(myDisasm.instr.repr, 'vmovdqu16 ymmword ptr [rax], ymm4')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovdqu16 ')
        assert_equal(myDisasm.instr.repr, 'vmovdqu16 zmmword ptr [rax], zmm4')
