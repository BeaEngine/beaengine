...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.repr, 'vmovdqa32 xmmword ptr [rax], xmm4')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vmovdqa32 ')
        assert_equal(myDisasm.infos.repr, 'vmovdqa32 ymmword ptr [rax], ymm4')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vmovdqa32 ')
        assert_equal(myDisasm.infos.repr, 'vmovdqa32 zmmword ptr [rax], zmm4')
        ...
        assert_equal(myDisasm.infos.repr, 'vmovdqa64 xmmword ptr [rax], xmm4')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vmovdqa64 ')
        assert_equal(myDisasm.infos.repr, 'vmovdqa64 ymmword ptr [rax], ymm4')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vmovdqa64 ')
        assert_equal(myDisasm.infos.repr, 'vmovdqa64 zmmword ptr [rax], zmm4')
        ...
        assert_equal(myDisasm.infos.repr, 'vmovdqu32 xmmword ptr [rax], xmm4')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vmovdqu32 ')
        assert_equal(myDisasm.infos.repr, 'vmovdqu32 ymmword ptr [rax], ymm4')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vmovdqu32 ')
        assert_equal(myDisasm.infos.repr, 'vmovdqu32 zmmword ptr [rax], zmm4')
        ...
        assert_equal(myDisasm.infos.repr, 'vmovdqu64 xmmword ptr [rax], xmm4')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vmovdqu64 ')
        assert_equal(myDisasm.infos.repr, 'vmovdqu64 ymmword ptr [rax], ymm4')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vmovdqu64 ')
        assert_equal(myDisasm.infos.repr, 'vmovdqu64 zmmword ptr [rax], zmm4')
        ...
        assert_equal(myDisasm.infos.repr, 'vmovdqu8 xmmword ptr [rax], xmm4')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vmovdqu8 ')
        assert_equal(myDisasm.infos.repr, 'vmovdqu8 ymmword ptr [rax], ymm4')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vmovdqu8 ')
        assert_equal(myDisasm.infos.repr, 'vmovdqu8 zmmword ptr [rax], zmm4')
        ...
        assert_equal(myDisasm.infos.repr, 'vmovdqu16 xmmword ptr [rax], xmm4')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vmovdqu16 ')
        assert_equal(myDisasm.infos.repr, 'vmovdqu16 ymmword ptr [rax], ymm4')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x7f)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vmovdqu16 ')
        assert_equal(myDisasm.infos.repr, 'vmovdqu16 zmmword ptr [rax], zmm4')
