...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpcmpgtb xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpcmpgtb ')
        assert_equal(myDisasm.instr.repr, 'vpcmpgtb ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpcmpgtb ')
        assert_equal(myDisasm.instr.repr, 'vpcmpgtb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x64')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpcmpgtb ')
        assert_equal(myDisasm.instr.repr, 'vpcmpgtb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x64')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpcmpgtb ')
        assert_equal(myDisasm.instr.repr, 'vpcmpgtb zmm1, zmm15, zmmword ptr [rsi]')
