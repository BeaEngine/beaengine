...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpgtb ')
        assert_equal(myDisasm.infos.repr, 'vpcmpgtb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x64')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpgtb ')
        assert_equal(myDisasm.infos.repr, 'vpcmpgtb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x64')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpgtb ')
        assert_equal(myDisasm.infos.repr, 'vpcmpgtb zmm1, zmm15, zmmword ptr [rsi]')
