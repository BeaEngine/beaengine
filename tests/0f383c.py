...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpmaxsb xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxsb ')
        assert_equal(myDisasm.instr.repr, 'vpmaxsb ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxsb ')
        assert_equal(myDisasm.instr.repr, 'vpmaxsb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x3c')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxsb ')
        assert_equal(myDisasm.instr.repr, 'vpmaxsb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x3c')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxsb ')
        assert_equal(myDisasm.instr.repr, 'vpmaxsb zmm1, zmm15, zmmword ptr [rsi]')
