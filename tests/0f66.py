...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpcmpgtd xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpcmpgtd ')
        assert_equal(myDisasm.instr.repr, 'vpcmpgtd ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpcmpgtd ')
        assert_equal(myDisasm.instr.repr, 'vpcmpgtd xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x66')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpcmpgtd ')
        assert_equal(myDisasm.instr.repr, 'vpcmpgtd ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x66')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpcmpgtd ')
        assert_equal(myDisasm.instr.repr, 'vpcmpgtd zmm1, zmm15, zmmword ptr [rsi]')
