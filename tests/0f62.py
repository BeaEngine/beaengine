...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpunpckldq ')
        assert_equal(myDisasm.infos.repr, 'vpunpckldq xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x62')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpunpckldq ')
        assert_equal(myDisasm.infos.repr, 'vpunpckldq ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x62')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpunpckldq ')
        assert_equal(myDisasm.infos.repr, 'vpunpckldq zmm1, zmm15, zmmword ptr [rsi]')
