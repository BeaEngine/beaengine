...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.repr, 'vgatherqps xmm0, qword ptr [rbx+xmm6+22h]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vgatherqps ')
        assert_equal(myDisasm.infos.repr, 'vgatherqps xmm0, qword ptr [rbx+ymm6+22h]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vgatherqps ')
        assert_equal(myDisasm.infos.repr, 'vgatherqps ymm0, qword ptr [rbx+zmm6+0088h]')
        ...
        assert_equal(myDisasm.infos.repr, 'vgatherqpd xmm0, qword ptr [rbx+xmm6+22h]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vgatherqpd ')
        assert_equal(myDisasm.infos.repr, 'vgatherqpd ymm0, qword ptr [rbx+ymm6+22h]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vgatherqpd ')
        assert_equal(myDisasm.infos.repr, 'vgatherqpd zmm0, qword ptr [rbx+zmm6+0110h]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vgatherqpd ')
        assert_equal(myDisasm.infos.repr, 'vgatherqpd ymm8, dword ptr [r11+ymm6+22h], ymm15')
        ...
        myDisasm.read()
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vgatherqps ')
        assert_equal(myDisasm.infos.repr, 'vgatherqps xmm8, qword ptr [r11+xmm6+22h], xmm15')
        ...
        myDisasm.read()
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vgatherqps ')
        assert_equal(myDisasm.infos.repr, 'vgatherqps xmm8, qword ptr [r11+ymm6+22h], xmm15')
