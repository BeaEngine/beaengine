...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsrlvd ')
        assert_equal(myDisasm.infos.repr, 'vpsrlvd xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x45')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsrlvd ')
        assert_equal(myDisasm.infos.repr, 'vpsrlvd ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x45')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsrlvd ')
        assert_equal(myDisasm.infos.repr, 'vpsrlvd zmm1, zmm15, zmmword ptr [rsi]')
        ...
        assert_equal(myDisasm.infos.repr, 'vpsrlvq zmm1, zmm15, zmmword ptr [rsi]')
