...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpsubd xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubd ')
        assert_equal(myDisasm.instr.repr, 'vpsubd ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubd ')
        assert_equal(myDisasm.instr.repr, 'vpsubd xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xfa')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubd ')
        assert_equal(myDisasm.instr.repr, 'vpsubd ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xfa')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubd ')
        assert_equal(myDisasm.instr.repr, 'vpsubd zmm1, zmm15, zmmword ptr [rsi]')
