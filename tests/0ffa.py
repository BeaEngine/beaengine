...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubd ')
        assert_equal(myDisasm.infos.repr, 'vpsubd xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xfa')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubd ')
        assert_equal(myDisasm.infos.repr, 'vpsubd ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xfa')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubd ')
        assert_equal(myDisasm.infos.repr, 'vpsubd zmm1, zmm15, zmmword ptr [rsi]')
