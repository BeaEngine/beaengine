...
class TestSuite:
    ...
    def test(self):
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x00)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpermq ')
        assert_equal(myDisasm.instr.repr, 'vpermq ymm12, ymm8, 11h')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x00)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpermq ')
        assert_equal(myDisasm.instr.repr, 'vpermq ymm4, ymmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x00)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpermq ')
        assert_equal(myDisasm.instr.repr, 'vpermq zmm4, zmmword ptr [rax], 11h')
