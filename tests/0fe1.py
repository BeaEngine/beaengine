...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpsraw xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsraw ')
        assert_equal(myDisasm.instr.repr, 'vpsraw ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsraw ')
        assert_equal(myDisasm.instr.repr, 'vpsraw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xe1')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsraw ')
        assert_equal(myDisasm.instr.repr, 'vpsraw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xe1')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsraw ')
        assert_equal(myDisasm.instr.repr, 'vpsraw zmm1, zmm15, zmmword ptr [rsi]')
