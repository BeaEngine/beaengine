...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x35)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmovzxdq ')
        assert_equal(myDisasm.infos.repr, 'vpmovzxdq xmm2, qword ptr [rax+00000000h]')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x35)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmovzxdq ')
        assert_equal(myDisasm.infos.repr, 'vpmovzxdq ymm2, xmmword ptr [rax+00000000h]')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x35)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmovzxdq ')
        assert_equal(myDisasm.infos.repr, 'vpmovzxdq zmm2, ymmword ptr [rax+00000000h]')
        ...
        assert_equal(myDisasm.infos.repr, 'vpmovqd qword ptr [rax+00000000h], xmm2')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x35)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmovqd ')
        assert_equal(myDisasm.infos.repr, 'vpmovqd xmmword ptr [rax+00000000h], ymm2')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x35)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmovqd ')
        assert_equal(myDisasm.infos.repr, 'vpmovqd ymmword ptr [rax+00000000h], zmm2')
