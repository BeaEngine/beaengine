...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vfmaddsub132ps xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmaddsub132ps ')
        assert_equal(myDisasm.instr.repr, 'vfmaddsub132ps ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmaddsub132ps ')
        assert_equal(myDisasm.instr.repr, 'vfmaddsub132ps xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x96')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmaddsub132ps ')
        assert_equal(myDisasm.instr.repr, 'vfmaddsub132ps ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x96')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmaddsub132ps ')
        assert_equal(myDisasm.instr.repr, 'vfmaddsub132ps zmm1, zmm15, zmmword ptr [rsi]')
        ...
        assert_equal(myDisasm.instr.repr, 'vfmaddsub132pd xmm9, xmm15, xmmword ptr [r14]')
