...
class TestSuite:
    def test(self):
        ...
        myDisasm.read()
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf17')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'movhps ')
        assert_equal(myDisasm.instr.repr, 'movhps qword ptr [rax+00000000h], xmm2')
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x17')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovhps ')
        assert_equal(myDisasm.instr.repr, 'vmovhps qword ptr [r8+00000000h], xmm10')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovhps ')
        assert_equal(myDisasm.instr.repr, 'vmovhps qword ptr [rax+00000000h], xmm2')
        ...
        assert_equal(myDisasm.instr.repr, 'movhpd qword ptr [rax+00000000h], xmm2')
        ...
        assert_equal(myDisasm.instr.repr, 'vmovhpd qword ptr [r8+00000000h], xmm10')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x17)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vmovhpd ')
        assert_equal(myDisasm.instr.repr, 'vmovhpd qword ptr [rax+00000000h], xmm2')
