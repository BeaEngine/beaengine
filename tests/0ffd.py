...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpaddw xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpaddw ')
        assert_equal(myDisasm.instr.repr, 'vpaddw ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpaddw ')
        assert_equal(myDisasm.instr.repr, 'vpaddw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xfd')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpaddw ')
        assert_equal(myDisasm.instr.repr, 'vpaddw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xfd')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpaddw ')
        assert_equal(myDisasm.instr.repr, 'vpaddw zmm1, zmm15, zmmword ptr [rsi]')
