...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpaddsw xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpaddsw ')
        assert_equal(myDisasm.instr.repr, 'vpaddsw ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpaddsw ')
        assert_equal(myDisasm.instr.repr, 'vpaddsw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xed')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpaddsw ')
        assert_equal(myDisasm.instr.repr, 'vpaddsw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xed')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpaddsw ')
        assert_equal(myDisasm.instr.repr, 'vpaddsw zmm1, zmm15, zmmword ptr [rsi]')
