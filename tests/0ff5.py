...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpmaddwd xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaddwd ')
        assert_equal(myDisasm.instr.repr, 'vpmaddwd ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaddwd ')
        assert_equal(myDisasm.instr.repr, 'vpmaddwd xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf5')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaddwd ')
        assert_equal(myDisasm.instr.repr, 'vpmaddwd ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf5')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaddwd ')
        assert_equal(myDisasm.instr.repr, 'vpmaddwd zmm1, zmm15, zmmword ptr [rsi]')
