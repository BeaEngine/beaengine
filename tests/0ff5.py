...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmaddwd ')
        assert_equal(myDisasm.infos.repr, 'vpmaddwd xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xf5')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmaddwd ')
        assert_equal(myDisasm.infos.repr, 'vpmaddwd ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xf5')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmaddwd ')
        assert_equal(myDisasm.infos.repr, 'vpmaddwd zmm1, zmm15, zmmword ptr [rsi]')
