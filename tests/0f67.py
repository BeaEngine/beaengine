...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpackuswb ')
        assert_equal(myDisasm.infos.repr, 'vpackuswb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x67')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpackuswb ')
        assert_equal(myDisasm.infos.repr, 'vpackuswb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x67')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpackuswb ')
        assert_equal(myDisasm.infos.repr, 'vpackuswb zmm1, zmm15, zmmword ptr [rsi]')
