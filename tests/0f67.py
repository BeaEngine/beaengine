...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpackuswb xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpackuswb ')
        assert_equal(myDisasm.instr.repr, 'vpackuswb ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpackuswb ')
        assert_equal(myDisasm.instr.repr, 'vpackuswb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x67')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpackuswb ')
        assert_equal(myDisasm.instr.repr, 'vpackuswb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x67')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpackuswb ')
        assert_equal(myDisasm.instr.repr, 'vpackuswb zmm1, zmm15, zmmword ptr [rsi]')
