...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpeqw ')
        assert_equal(myDisasm.infos.repr, 'vpcmpeqw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x75')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpeqw ')
        assert_equal(myDisasm.infos.repr, 'vpcmpeqw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x75')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpeqw ')
        assert_equal(myDisasm.infos.repr, 'vpcmpeqw zmm1, zmm15, zmmword ptr [rsi]')
