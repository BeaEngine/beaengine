...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x22)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmovsxbq ')
        assert_equal(myDisasm.infos.repr, 'vpmovsxbq xmm2, qword ptr [rax+00000000h]')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x22)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmovsxbq ')
        assert_equal(myDisasm.infos.repr, 'vpmovsxbq ymm2, xmmword ptr [rax+00000000h]')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x22)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmovsxbq ')
        assert_equal(myDisasm.infos.repr, 'vpmovsxbq zmm2, ymmword ptr [rax+00000000h]')
        ...
        assert_equal(myDisasm.infos.repr, 'vpmovsqb qword ptr [rax+00000000h], xmm2')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x22)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmovsqb ')
        assert_equal(myDisasm.infos.repr, 'vpmovsqb xmmword ptr [rax+00000000h], ymm2')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x22)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmovsqb ')
        assert_equal(myDisasm.infos.repr, 'vpmovsqb ymmword ptr [rax+00000000h], zmm2')
