...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsub132ps ')
        assert_equal(myDisasm.infos.repr, 'vfmsub132ps xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x9a')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsub132ps ')
        assert_equal(myDisasm.infos.repr, 'vfmsub132ps ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x9a')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsub132ps ')
        assert_equal(myDisasm.infos.repr, 'vfmsub132ps zmm1, zmm15, zmmword ptr [rsi]')
        ...
        assert_equal(myDisasm.infos.repr, 'v4fmaddps zmm1, zmm4...zmm7, xmmword ptr [rsi]')
