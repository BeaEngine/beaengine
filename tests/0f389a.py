...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vfmsub132ps xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmsub132ps ')
        assert_equal(myDisasm.instr.repr, 'vfmsub132ps ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmsub132ps ')
        assert_equal(myDisasm.instr.repr, 'vfmsub132ps xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x9a')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmsub132ps ')
        assert_equal(myDisasm.instr.repr, 'vfmsub132ps ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x9a')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmsub132ps ')
        assert_equal(myDisasm.instr.repr, 'vfmsub132ps zmm1, zmm15, zmmword ptr [rsi]')
        ...
        assert_equal(myDisasm.instr.repr, 'vfmsub132pd xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x9a)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'v4fmaddps ')
        assert_equal(myDisasm.instr.Argument2.Registers.zmm, REG4+REG5+REG6+REG7)
        assert_equal(myDisasm.instr.repr, 'v4fmaddps zmm1, zmm4...zmm7, xmmword ptr [rsi]')
