...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpslld ')
        assert_equal(myDisasm.infos.repr, 'vpslld xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xf2')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpslld ')
        assert_equal(myDisasm.infos.repr, 'vpslld ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xf2')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpslld ')
        assert_equal(myDisasm.infos.repr, 'vpslld zmm1, zmm15, zmmword ptr [rsi]')
