...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpslld xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpslld ')
        assert_equal(myDisasm.instr.repr, 'vpslld ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpslld ')
        assert_equal(myDisasm.instr.repr, 'vpslld xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf2')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpslld ')
        assert_equal(myDisasm.instr.repr, 'vpslld ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf2')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpslld ')
        assert_equal(myDisasm.instr.repr, 'vpslld zmm1, zmm15, zmmword ptr [rsi]')
