...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vfmsubadd213ps xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmsubadd213ps ')
        assert_equal(myDisasm.instr.repr, 'vfmsubadd213ps ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmsubadd213ps ')
        assert_equal(myDisasm.instr.repr, 'vfmsubadd213ps xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xa7')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmsubadd213ps ')
        assert_equal(myDisasm.instr.repr, 'vfmsubadd213ps ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xa7')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmsubadd213ps ')
        assert_equal(myDisasm.instr.repr, 'vfmsubadd213ps zmm1, zmm15, zmmword ptr [rsi]')
        ...
        assert_equal(myDisasm.instr.repr, 'vfmsubadd213pd xmm9, xmm15, xmmword ptr [r14]')
