...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsubadd213ps ')
        assert_equal(myDisasm.infos.repr, 'vfmsubadd213ps xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xa7')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsubadd213ps ')
        assert_equal(myDisasm.infos.repr, 'vfmsubadd213ps ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xa7')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsubadd213ps ')
        assert_equal(myDisasm.infos.repr, 'vfmsubadd213ps zmm1, zmm15, zmmword ptr [rsi]')
