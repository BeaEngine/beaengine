...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpxor xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpxor ')
        assert_equal(myDisasm.instr.repr, 'vpxor ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.repr, 'vpxord xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xef')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpxord ')
        assert_equal(myDisasm.instr.repr, 'vpxord ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xef')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpxord ')
        assert_equal(myDisasm.instr.repr, 'vpxord zmm1, zmm15, zmmword ptr [rsi]')
