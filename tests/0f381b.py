...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vbroadcastf32x8 ')
        assert_equal(myDisasm.instr.repr, 'vbroadcastf32x8 zmm4, ymmword ptr [rax]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x1b)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vbroadcastf64x4 ')
        assert_equal(myDisasm.instr.repr, 'vbroadcastf64x4 zmm4, ymmword ptr [rax]')
