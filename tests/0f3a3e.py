...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(myDisasm.infos.repr, 'vpcmpequb k4, xmm0, xmmword ptr [rax], 10h')
        ...
        assert_equal(myDisasm.infos.repr, 'vpcmpltub k4, xmm0, xmmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.infos.repr, 'vpcmpleub k4, xmm0, xmmword ptr [rax], 12h')
        ...
        assert_equal(myDisasm.infos.repr, 'vpcmpfalseub k4, xmm0, xmmword ptr [rax], 13h')
        ...
        assert_equal(myDisasm.infos.repr, 'vpcmpnequb k4, xmm0, xmmword ptr [rax], 14h')
        ...
        assert_equal(myDisasm.infos.repr, 'vpcmpnltub k4, xmm0, xmmword ptr [rax], 15h')
        ...
        assert_equal(myDisasm.infos.repr, 'vpcmpnleub k4, xmm0, xmmword ptr [rax], 16h')
        ...
        assert_equal(myDisasm.infos.repr, 'vpcmptrueub k4, xmm0, xmmword ptr [rax], 17h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x3e)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpequb ')
        assert_equal(myDisasm.infos.repr, 'vpcmpequb k4, ymm0, ymmword ptr [rax], 10h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x3e)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpequb ')
        assert_equal(myDisasm.infos.repr, 'vpcmpequb k4, zmm0, zmmword ptr [rax], 10h')
        ...
        assert_equal(myDisasm.infos.repr, 'vpcmpequw k4, xmm0, xmmword ptr [rax], 10h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x3e)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpequw ')
        assert_equal(myDisasm.infos.repr, 'vpcmpequw k4, ymm0, ymmword ptr [rax], 10h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x3e)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpequw ')
        assert_equal(myDisasm.infos.repr, 'vpcmpequw k4, zmm0, zmmword ptr [rax], 10h')
