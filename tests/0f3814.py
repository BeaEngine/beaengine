...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vblendvps ')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vprorvd ')
        assert_equal(myDisasm.instr.repr, 'vprorvd xmm2, xmm0, xmmword ptr [rsi]')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x14)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vprorvd ')
        assert_equal(myDisasm.instr.repr, 'vprorvd ymm2, ymm0, ymmword ptr [rsi]')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x14)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vprorvd ')
        assert_equal(myDisasm.instr.repr, 'vprorvd zmm2, zmm0, zmmword ptr [rsi]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x14)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vprorvq ')
        assert_equal(myDisasm.instr.repr, 'vprorvq xmm2, xmm0, xmmword ptr [rsi]')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x14)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vprorvq ')
        assert_equal(myDisasm.instr.repr, 'vprorvq ymm2, ymm0, ymmword ptr [rsi]')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x14)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vprorvq ')
        assert_equal(myDisasm.instr.repr, 'vprorvq zmm2, zmm0, zmmword ptr [rsi]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x14)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmovusqw ')
        assert_equal(myDisasm.instr.repr, 'vpmovusqw dword ptr [rsi], xmm2')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x14)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmovusqw ')
        assert_equal(myDisasm.instr.repr, 'vpmovusqw xmm2, xmm1')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x14)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmovusqw ')
        assert_equal(myDisasm.instr.repr, 'vpmovusqw qword ptr [rsi], ymm2')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x14)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmovusqw ')
        assert_equal(myDisasm.instr.repr, 'vpmovusqw xmm2, ymm1')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x14)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmovusqw ')
        assert_equal(myDisasm.instr.repr, 'vpmovusqw xmmword ptr [rsi], zmm2')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x14)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmovusqw ')
        assert_equal(myDisasm.instr.repr, 'vpmovusqw xmm2, zmm1')
