...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfnmadd231ss ')
        assert_equal(myDisasm.infos.repr, 'vfnmadd231ss xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xbd')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfnmadd231ss ')
        assert_equal(myDisasm.infos.repr, 'vfnmadd231ss ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xbd')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfnmadd231ss ')
        assert_equal(myDisasm.infos.repr, 'vfnmadd231ss zmm1, zmm15, zmmword ptr [rsi]')
