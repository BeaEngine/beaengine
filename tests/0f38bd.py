...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vfnmadd231ss xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfnmadd231ss ')
        assert_equal(myDisasm.instr.repr, 'vfnmadd231ss ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfnmadd231ss ')
        assert_equal(myDisasm.instr.repr, 'vfnmadd231ss xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xbd')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfnmadd231ss ')
        assert_equal(myDisasm.instr.repr, 'vfnmadd231ss ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xbd')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfnmadd231ss ')
        assert_equal(myDisasm.instr.repr, 'vfnmadd231ss zmm1, zmm15, zmmword ptr [rsi]')
        ...
        assert_equal(myDisasm.instr.repr, 'vfnmadd231sd xmm9, xmm15, xmmword ptr [r14]')
