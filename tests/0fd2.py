...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpsrld xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsrld ')
        assert_equal(myDisasm.instr.repr, 'vpsrld ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsrld ')
        assert_equal(myDisasm.instr.repr, 'vpsrld xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xd2')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsrld ')
        assert_equal(myDisasm.instr.repr, 'vpsrld ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xd2')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsrld ')
        assert_equal(myDisasm.instr.repr, 'vpsrld zmm1, zmm15, zmmword ptr [rsi]')
