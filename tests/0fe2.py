...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsrad ')
        assert_equal(myDisasm.infos.repr, 'vpsrad xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xe2')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsrad ')
        assert_equal(myDisasm.infos.repr, 'vpsrad ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xe2')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsrad ')
        assert_equal(myDisasm.infos.repr, 'vpsrad zmm1, zmm15, zmmword ptr [rsi]')
