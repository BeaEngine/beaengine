...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpsrad xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsrad ')
        assert_equal(myDisasm.instr.repr, 'vpsrad ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsrad ')
        assert_equal(myDisasm.instr.repr, 'vpsrad xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xe2')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsrad ')
        assert_equal(myDisasm.instr.repr, 'vpsrad ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xe2')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsrad ')
        assert_equal(myDisasm.instr.repr, 'vpsrad zmm1, zmm15, zmmword ptr [rsi]')
