...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpcmpeqb xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpcmpeqb ')
        assert_equal(myDisasm.instr.repr, 'vpcmpeqb ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpcmpeqb ')
        assert_equal(myDisasm.instr.repr, 'vpcmpeqb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x74')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpcmpeqb ')
        assert_equal(myDisasm.instr.repr, 'vpcmpeqb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x74')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpcmpeqb ')
        assert_equal(myDisasm.instr.repr, 'vpcmpeqb zmm1, zmm15, zmmword ptr [rsi]')
