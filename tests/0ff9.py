...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubw ')
        assert_equal(myDisasm.infos.repr, 'vpsubw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xf9')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubw ')
        assert_equal(myDisasm.infos.repr, 'vpsubw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xf9')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubw ')
        assert_equal(myDisasm.infos.repr, 'vpsubw zmm1, zmm15, zmmword ptr [rsi]')
