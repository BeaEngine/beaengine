...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpsubw xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubw ')
        assert_equal(myDisasm.instr.repr, 'vpsubw ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubw ')
        assert_equal(myDisasm.instr.repr, 'vpsubw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf9')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubw ')
        assert_equal(myDisasm.instr.repr, 'vpsubw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf9')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubw ')
        assert_equal(myDisasm.instr.repr, 'vpsubw zmm1, zmm15, zmmword ptr [rsi]')
