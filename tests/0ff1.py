...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpsllw xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsllw ')
        assert_equal(myDisasm.instr.repr, 'vpsllw ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsllw ')
        assert_equal(myDisasm.instr.repr, 'vpsllw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf1')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsllw ')
        assert_equal(myDisasm.instr.repr, 'vpsllw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf1')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsllw ')
        assert_equal(myDisasm.instr.repr, 'vpsllw zmm1, zmm15, zmmword ptr [rsi]')
