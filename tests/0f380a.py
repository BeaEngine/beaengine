...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf380a')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'psignd ')
        assert_equal(myDisasm.instr.repr, 'psignd xmm2, xmmword ptr [rax+44332211h]')
        ...
        assert_equal(myDisasm.instr.repr, 'vpsignd xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsignd ')
        assert_equal(myDisasm.instr.repr, 'vpsignd ymm9, ymm15, ymmword ptr [r14]')
