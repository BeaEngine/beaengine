...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpmaxuw xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxuw ')
        assert_equal(myDisasm.instr.repr, 'vpmaxuw ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxuw ')
        assert_equal(myDisasm.instr.repr, 'vpmaxuw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x3e')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxuw ')
        assert_equal(myDisasm.instr.repr, 'vpmaxuw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x3e')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxuw ')
        assert_equal(myDisasm.instr.repr, 'vpmaxuw zmm1, zmm15, zmmword ptr [rsi]')
