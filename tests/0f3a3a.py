...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(myDisasm.infos.repr, 'vinserti32x8 zmm4, zmm0, ymmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x3a)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vinserti32x8 ')
        assert_equal(myDisasm.infos.repr, 'vinserti32x8 zmm0, zmm0, ymm0, 11h')
        ...
        assert_equal(myDisasm.infos.repr, 'vinserti64x4 zmm4, zmm0, ymmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x3a)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vinserti64x4 ')
        assert_equal(myDisasm.infos.repr, 'vinserti64x4 zmm0, zmm0, ymm0, 11h')
