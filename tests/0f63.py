...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpacksswb xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpacksswb ')
        assert_equal(myDisasm.instr.repr, 'vpacksswb ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpacksswb ')
        assert_equal(myDisasm.instr.repr, 'vpacksswb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x63')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpacksswb ')
        assert_equal(myDisasm.instr.repr, 'vpacksswb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x63')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpacksswb ')
        assert_equal(myDisasm.instr.repr, 'vpacksswb zmm1, zmm15, zmmword ptr [rsi]')
