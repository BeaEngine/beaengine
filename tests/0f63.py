...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpacksswb ')
        assert_equal(myDisasm.infos.repr, 'vpacksswb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x63')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpacksswb ')
        assert_equal(myDisasm.infos.repr, 'vpacksswb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x63')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpacksswb ')
        assert_equal(myDisasm.infos.repr, 'vpacksswb zmm1, zmm15, zmmword ptr [rsi]')
