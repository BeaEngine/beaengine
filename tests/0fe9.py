...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpsubsw xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubsw ')
        assert_equal(myDisasm.instr.repr, 'vpsubsw ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubsw ')
        assert_equal(myDisasm.instr.repr, 'vpsubsw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xe9')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubsw ')
        assert_equal(myDisasm.instr.repr, 'vpsubsw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xe9')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubsw ')
        assert_equal(myDisasm.instr.repr, 'vpsubsw zmm1, zmm15, zmmword ptr [rsi]')
