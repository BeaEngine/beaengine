...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubsw ')
        assert_equal(myDisasm.infos.repr, 'vpsubsw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xe9')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubsw ')
        assert_equal(myDisasm.infos.repr, 'vpsubsw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xe9')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubsw ')
        assert_equal(myDisasm.infos.repr, 'vpsubsw zmm1, zmm15, zmmword ptr [rsi]')
