...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(myDisasm.infos.repr, 'vextracti32x4 ymm4, ymm0, xmmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x39)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vextracti32x4 ')
        assert_equal(myDisasm.infos.repr, 'vextracti32x4 zmm4, zmm0, xmmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.infos.repr, 'vextracti64x2 ymm4, ymm0, xmmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x39)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vextracti64x2 ')
        assert_equal(myDisasm.infos.repr, 'vextracti64x2 zmm4, zmm0, xmmword ptr [rax], 11h')
