...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf3808')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'psignb ')
        assert_equal(myDisasm.instr.repr, 'psignb xmm2, xmmword ptr [rax+44332211h]')
        ...
        assert_equal(myDisasm.instr.repr, 'vpsignb xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsignb ')
        assert_equal(myDisasm.instr.repr, 'vpsignb ymm9, ymm15, ymmword ptr [r14]')
