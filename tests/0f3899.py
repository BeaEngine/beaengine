...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmadd132ss ')
        assert_equal(myDisasm.infos.repr, 'vfmadd132ss xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x99')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmadd132ss ')
        assert_equal(myDisasm.infos.repr, 'vfmadd132ss ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x99')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmadd132ss ')
        assert_equal(myDisasm.infos.repr, 'vfmadd132ss zmm1, zmm15, zmmword ptr [rsi]')
