...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpmullw xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmullw ')
        assert_equal(myDisasm.instr.repr, 'vpmullw ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmullw ')
        assert_equal(myDisasm.instr.repr, 'vpmullw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xd5')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmullw ')
        assert_equal(myDisasm.instr.repr, 'vpmullw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xd5')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmullw ')
        assert_equal(myDisasm.instr.repr, 'vpmullw zmm1, zmm15, zmmword ptr [rsi]')
