...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsadbw ')
        assert_equal(myDisasm.infos.repr, 'vpsadbw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xf6')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsadbw ')
        assert_equal(myDisasm.infos.repr, 'vpsadbw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xf6')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsadbw ')
        assert_equal(myDisasm.infos.repr, 'vpsadbw zmm1, zmm15, zmmword ptr [rsi]')
