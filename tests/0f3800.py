...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf3800')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'pshufb ')
        assert_equal(myDisasm.instr.repr, 'pshufb xmm2, xmmword ptr [rax+44332211h]')
        ...
        assert_equal(myDisasm.instr.repr, 'vpshufb xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpshufb ')
        assert_equal(myDisasm.instr.repr, 'vpshufb ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpshufb ')
        assert_equal(myDisasm.instr.repr, 'vpshufb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x0')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpshufb ')
        assert_equal(myDisasm.instr.repr, 'vpshufb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x0')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpshufb ')
        assert_equal(myDisasm.instr.repr, 'vpshufb zmm1, zmm15, zmmword ptr [rsi]')
