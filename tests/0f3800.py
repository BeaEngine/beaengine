...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpshufb ')
        assert_equal(myDisasm.infos.repr, 'vpshufb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x0')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpshufb ')
        assert_equal(myDisasm.infos.repr, 'vpshufb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x0')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpshufb ')
        assert_equal(myDisasm.infos.repr, 'vpshufb zmm1, zmm15, zmmword ptr [rsi]')
