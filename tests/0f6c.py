...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpunpcklqdq xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpcklqdq ')
        assert_equal(myDisasm.instr.repr, 'vpunpcklqdq ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpcklqdq ')
        assert_equal(myDisasm.instr.repr, 'vpunpcklqdq xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x6c')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpcklqdq ')
        assert_equal(myDisasm.instr.repr, 'vpunpcklqdq ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x6c')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpcklqdq ')
        assert_equal(myDisasm.instr.repr, 'vpunpcklqdq zmm1, zmm15, zmmword ptr [rsi]')
