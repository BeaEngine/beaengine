...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf3809')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'psignw ')
        assert_equal(myDisasm.instr.repr, 'psignw xmm2, xmmword ptr [rax+44332211h]')
        ...
        assert_equal(myDisasm.instr.repr, 'vpsignw xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsignw ')
        assert_equal(myDisasm.instr.repr, 'vpsignw ymm9, ymm15, ymmword ptr [r14]')
