...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubb ')
        assert_equal(myDisasm.infos.repr, 'vpsubb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xf8')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubb ')
        assert_equal(myDisasm.infos.repr, 'vpsubb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xf8')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubb ')
        assert_equal(myDisasm.infos.repr, 'vpsubb zmm1, zmm15, zmmword ptr [rsi]')
