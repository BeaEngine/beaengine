...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpsubb xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubb ')
        assert_equal(myDisasm.instr.repr, 'vpsubb ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubb ')
        assert_equal(myDisasm.instr.repr, 'vpsubb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf8')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubb ')
        assert_equal(myDisasm.instr.repr, 'vpsubb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xf8')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubb ')
        assert_equal(myDisasm.instr.repr, 'vpsubb zmm1, zmm15, zmmword ptr [rsi]')
