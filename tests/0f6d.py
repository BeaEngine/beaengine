...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpunpckhqdq xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpckhqdq ')
        assert_equal(myDisasm.instr.repr, 'vpunpckhqdq ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpckhqdq ')
        assert_equal(myDisasm.instr.repr, 'vpunpckhqdq xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x6d')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpckhqdq ')
        assert_equal(myDisasm.instr.repr, 'vpunpckhqdq ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x6d')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpckhqdq ')
        assert_equal(myDisasm.instr.repr, 'vpunpckhqdq zmm1, zmm15, zmmword ptr [rsi]')
