...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpavgb xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpavgb ')
        assert_equal(myDisasm.instr.repr, 'vpavgb ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpavgb ')
        assert_equal(myDisasm.instr.repr, 'vpavgb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xe0')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpavgb ')
        assert_equal(myDisasm.instr.repr, 'vpavgb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xe0')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpavgb ')
        assert_equal(myDisasm.instr.repr, 'vpavgb zmm1, zmm15, zmmword ptr [rsi]')
