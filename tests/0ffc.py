...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpaddb ')
        assert_equal(myDisasm.infos.repr, 'vpaddb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xfc')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpaddb ')
        assert_equal(myDisasm.infos.repr, 'vpaddb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xfc')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpaddb ')
        assert_equal(myDisasm.infos.repr, 'vpaddb zmm1, zmm15, zmmword ptr [rsi]')
