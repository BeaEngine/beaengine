...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpaddb xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpaddb ')
        assert_equal(myDisasm.instr.repr, 'vpaddb ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpaddb ')
        assert_equal(myDisasm.instr.repr, 'vpaddb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xfc')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpaddb ')
        assert_equal(myDisasm.instr.repr, 'vpaddb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xfc')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpaddb ')
        assert_equal(myDisasm.instr.repr, 'vpaddb zmm1, zmm15, zmmword ptr [rsi]')
