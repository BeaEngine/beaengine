...
class TestSuite:
    ...
    def test_blendvps(self):
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 128)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'blendvps xmm10, xmmword ptr [rax+11111111h]')
    ...
    def test_cmppd(self):
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpltpd xmm0, xmmword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmplepd xmm0, xmmword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpunordpd xmm0, xmmword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpneqpd xmm0, xmmword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpnltpd xmm0, xmmword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpnlepd xmm0, xmmword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpordpd xmm0, xmmword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpeqpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpltpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmplepd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpunordpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpneqpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpnltpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpnlepd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpordpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpeq_uqpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpngepd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpngtpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpfalsepd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpneq_oqpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpgepd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpgtpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmptruepd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpeq_ospd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmplt_oqpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmple_oqpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpunord_spd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpneq_uspd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpnlt_uqpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpnle_uqpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpord_spd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpeq_uspd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpnge_uqpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpngt_uqpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpfalse_ospd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpneq_ospd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpge_oqpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpgt_oqpd xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmptrue_uspd xmm8, xmm15, xmmword ptr [r8]')

        Buffer = b'\xc4\x01\x05\xc2\x00\x1f\x11\x11\x11\x11\x11\x11\x11\x11\x11'
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.instr.Argument1.ArgType, REGISTER_TYPE + AVX_REG + REG8)
        assert_equal(myDisasm.instr.Argument1.ArgSize, 256)
        assert_equal(myDisasm.instr.Argument1.AccessMode, READ)
        assert_equal(myDisasm.instr.Argument2.ArgType, REGISTER_TYPE + AVX_REG + REG15)
        assert_equal(myDisasm.instr.Argument2.ArgSize, 256)
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmptrue_uspd ymm8, ymm15, ymmword ptr [r8]')
    ...
    def test_cmpps(self):
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpltps xmm0, xmmword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpleps xmm0, xmmword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpunordps xmm0, xmmword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpneqps xmm0, xmmword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpnltps xmm0, xmmword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpnleps xmm0, xmmword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpordps xmm0, xmmword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpeqps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpltps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpleps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpunordps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpneqps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpnltps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpnleps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpordps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpeq_uqps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpngeps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpngtps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpfalseps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpneq_oqps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpgeps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpgtps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmptrueps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpeq_osps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmplt_oqps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmple_oqps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpunord_sps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpneq_usps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpnlt_uqps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpnle_uqps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpord_sps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpeq_usps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpnge_uqps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpngt_uqps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpfalse_osps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpneq_osps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpge_oqps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmpgt_oqps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmptrue_usps xmm8, xmm15, xmmword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.Argument4.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument4.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'vcmptrue_usps ymm8, ymm15, ymmword ptr [r8]')
    ...
    def test_cmpsd(self):
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpltsd xmm0, qword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmplesd xmm0, qword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpunordsd xmm0, qword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpneqsd xmm0, qword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpnltsd xmm0, qword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpnlesd xmm0, qword ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Argument3.ArgSize, 8)
        assert_equal(myDisasm.instr.Argument3.AccessMode, READ)
        assert_equal(myDisasm.instr.repr, 'cmpordsd xmm0, qword ptr [rax]')
