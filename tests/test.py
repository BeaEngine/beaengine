...
class TestSuite:
    ...
    def test_adcx(self):
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.infos.Argument1.ArgType, REGISTER_TYPE) #GENERAL_REG) # REG2)
        assert_equal(myDisasm.infos.Argument1.ArgSize, 32)
        assert_equal(myDisasm.infos.Argument1.AccessMode, WRITE)
        assert_equal(myDisasm.infos.Argument2.ArgType, MEMORY_TYPE)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 32)
        assert_equal(myDisasm.infos.Argument2.AccessMode, READ)
    ...
    def test_imul(self):
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.infos.Argument1.ArgType, REGISTER_TYPE) #GENERAL_REG) # REG0)
        assert_equal(myDisasm.infos.Argument1.ArgSize, 32)
        assert_equal(myDisasm.infos.Argument1.AccessMode, WRITE)
        assert_equal(myDisasm.infos.Argument2.ArgType, MEMORY_TYPE)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 32)
    ...
    def test_VEX3Bytes(self):
        ...
        assert_equal(myDisasm.infos.Argument1.AccessMode, WRITE)
        assert_equal(myDisasm.infos.Argument2.ArgType, REGISTER_TYPE) #GENERAL_REG) # REG15)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 64)
        assert_equal(myDisasm.infos.Argument2.AccessMode, WRITE)
        assert_equal(myDisasm.infos.Argument3.ArgType, MEMORY_TYPE)
        assert_equal(myDisasm.infos.Argument3.ArgSize, 64)
        assert_equal(myDisasm.infos.Argument3.AccessMode, READ)
    ...
    def test_addpd(self):
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.infos.Argument1.ArgType, REGISTER_TYPE) #SSE_REG) # REG10)
        assert_equal(myDisasm.infos.Argument1.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument1.AccessMode, WRITE)
        assert_equal(myDisasm.infos.Argument2.ArgType, MEMORY_TYPE)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument2.AccessMode, READ)
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.infos.Argument1.ArgType, REGISTER_TYPE) #SSE_REG) # REG2)
        assert_equal(myDisasm.infos.Argument1.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument1.AccessMode, WRITE)
        assert_equal(myDisasm.infos.Argument2.ArgType, MEMORY_TYPE)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 128)
        ...
        assert_equal(myDisasm.infos.Argument1.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument1.AccessMode, WRITE)
        assert_equal(myDisasm.infos.Argument2.ArgType, REGISTER_TYPE) #SSE_REG) # REG15)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument2.AccessMode, READ)
        assert_equal(myDisasm.infos.Argument3.ArgType, MEMORY_TYPE)
        assert_equal(myDisasm.infos.Argument3.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument3.AccessMode, READ)
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.infos.Argument1.ArgType, REGISTER_TYPE) #AVX_REG) # REG2)
        assert_equal(myDisasm.infos.Argument1.ArgSize, 256)
        assert_equal(myDisasm.infos.Argument1.AccessMode, WRITE)
        assert_equal(myDisasm.infos.Argument2.ArgType, REGISTER_TYPE) #AVX_REG) # REG15)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 256)
        assert_equal(myDisasm.infos.Argument2.AccessMode, READ)
        assert_equal(myDisasm.infos.Argument3.ArgType, MEMORY_TYPE)
        assert_equal(myDisasm.infos.Argument3.ArgSize, 256)
        assert_equal(myDisasm.infos.Argument3.AccessMode, READ)
    ...
    def test_addss(self):
        ...
        assert_equal(myDisasm.infos.Argument2.AccessMode, READ)
        assert_equal(myDisasm.infos.Argument3.ArgType, MEMORY_TYPE)
        assert_equal(myDisasm.infos.Argument3.ArgSize, 32)
        assert_equal(myDisasm.infos.Argument3.AccessMode, READ)
    ...
    def test_mov(self):
        ...
        assert_equal(myDisasm.infos.Argument1.ArgSize, 32)
        assert_equal(myDisasm.infos.Argument1.AccessMode, WRITE)
        assert_equal(myDisasm.infos.Argument2.ArgType, CONSTANT_TYPE+ABSOLUTE_)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 32)
        assert_equal(myDisasm.infos.Argument2.AccessMode, READ)
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.infos.Argument1.ArgType, REGISTER_TYPE) #GENERAL_REG) # REG8)
        assert_equal(myDisasm.infos.Argument1.ArgSize, 32)
        assert_equal(myDisasm.infos.Argument1.AccessMode, WRITE)
        assert_equal(hex(myDisasm.infos.Argument2.ArgType), hex(CONSTANT_TYPE+ABSOLUTE_))
        assert_equal(myDisasm.infos.Argument2.ArgSize, 32)
        assert_equal(myDisasm.infos.Argument2.AccessMode, READ)
        assert_equal(myDisasm.infos.Instruction.Immediat, 0x104)
    ...
    def test_addsubpd(self):
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.infos.Argument1.ArgType, REGISTER_TYPE) #AVX_REG) # REG10)
        assert_equal(myDisasm.infos.Argument1.ArgSize, 256)
        assert_equal(myDisasm.infos.Argument1.AccessMode, WRITE)
        assert_equal(myDisasm.infos.Argument2.ArgType, REGISTER_TYPE) #AVX_REG) # REG15)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 256)
    ...
    def test_aeskeygenassist(self):
        ...
        assert_equal(myDisasm.infos.Argument2.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument2.AccessMode, READ)
        assert_equal(myDisasm.infos.Argument3.ArgType, CONSTANT_TYPE + ABSOLUTE_)
        assert_equal(myDisasm.infos.Argument3.ArgSize, 8)
        assert_equal(myDisasm.infos.Argument3.AccessMode, READ)
    ...
    def test_andn(self):
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.infos.Argument1.ArgType, REGISTER_TYPE) #GENERAL_REG) # REG10)
        assert_equal(myDisasm.infos.Argument1.ArgSize, 32)
        assert_equal(myDisasm.infos.Argument1.AccessMode, WRITE)
        assert_equal(myDisasm.infos.Argument2.ArgType, REGISTER_TYPE) #GENERAL_REG) # REG15)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 32)
    ...
    def test_bextr(self):
        ...
        assert_equal(myDisasm.infos.Argument2.ArgSize, 32)
        assert_equal(myDisasm.infos.Argument2.AccessMode, READ)
        assert_equal(myDisasm.infos.Argument3.ArgType, REGISTER_TYPE) #GENERAL_REG) # REG15)
        assert_equal(myDisasm.infos.Argument3.ArgSize, 8)
        assert_equal(myDisasm.infos.Argument3.AccessMode, READ)
    ...
    def test_blendvpd(self):
        ...
        assert_equal(myDisasm.infos.Argument2.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument2.AccessMode, READ)
        assert_equal(myDisasm.infos.Argument3.ArgType, REGISTER_TYPE) #SSE_REG) # REG0)
        assert_equal(myDisasm.infos.Argument3.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument3.AccessMode, READ)
        ...
        assert_equal(myDisasm.infos.Argument4.ArgType, REGISTER_TYPE) #AVX_REG) # REG0)
        assert_equal(myDisasm.infos.Argument4.ArgSize, 256)
        assert_equal(myDisasm.infos.Argument4.AccessMode, READ)
        ...
        assert_equal(myDisasm.infos.Argument4.ArgType, REGISTER_TYPE) #SSE_REG) # REG0)
        assert_equal(myDisasm.infos.Argument4.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument4.AccessMode, READ)
    ...
    def test_blsi(self):
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.infos.Argument1.ArgType, REGISTER_TYPE) #GENERAL_REG) # REG15)
        assert_equal(myDisasm.infos.Argument1.ArgSize, 32)
        assert_equal(myDisasm.infos.Argument1.AccessMode, WRITE)
        assert_equal(myDisasm.infos.Argument2.ArgType, MEMORY_TYPE)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 32)
    ...
    def test_cmppd(self):
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.infos.Argument1.ArgType, REGISTER_TYPE) #SSE_REG) # REG0)
        assert_equal(myDisasm.infos.Argument1.ArgSize, 128)
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.infos.Argument1.ArgType, REGISTER_TYPE) #SSE_REG) # REG8)
        assert_equal(myDisasm.infos.Argument1.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument1.AccessMode, READ)
        assert_equal(myDisasm.infos.Argument2.ArgType, REGISTER_TYPE) #SSE_REG) # REG15)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 128)
        ...
        assert_equal(myDisasm.infos.Argument3.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument3.AccessMode, READ)
        assert_equal(myDisasm.infos.Argument4.ArgType,  + CONSTANT_TYPE+ABSOLUTE_)
        assert_equal(myDisasm.infos.Argument4.ArgSize, 8)
        assert_equal(myDisasm.infos.Argument4.AccessMode, READ)
    ...
    def test_mpx(self):
        ...
        assert_equal(myDisasm.infos.Argument1.ArgType, REGISTER_TYPE) #MPX_REG) #REG1)
        assert_equal(myDisasm.infos.Argument1.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument1.AccessMode, READ)
        assert_equal(myDisasm.infos.Argument2.ArgType, MEMORY_TYPE)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 32)
        ...
        assert_equal(myDisasm.infos.Argument1.ArgType, REGISTER_TYPE) #MPX_REG) # + REG0)
        assert_equal(myDisasm.infos.Argument1.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument1.AccessMode, WRITE)
        assert_equal(myDisasm.infos.Argument2.ArgType, REGISTER_TYPE) #MPX_REG) # + REG0)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument2.AccessMode, READ)
        ...
        assert_equal(myDisasm.infos.Argument1.ArgSize, 64)
        assert_equal(myDisasm.infos.Argument1.AccessMode, WRITE)
        assert_equal(myDisasm.infos.Argument2.ArgType, REGISTER_TYPE) #MPX_REG) #REG1)
        assert_equal(myDisasm.infos.Argument2.ArgSize, 128)
        assert_equal(myDisasm.infos.Argument2.AccessMode, READ)
