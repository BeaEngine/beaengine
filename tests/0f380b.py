...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpmulhrsw xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmulhrsw ')
        assert_equal(myDisasm.instr.repr, 'vpmulhrsw ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmulhrsw ')
        assert_equal(myDisasm.instr.repr, 'vpmulhrsw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0xb)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmulhrsw ')
        assert_equal(myDisasm.instr.repr, 'vpmulhrsw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0xb)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmulhrsw ')
        assert_equal(myDisasm.instr.repr, 'vpmulhrsw zmm1, zmm15, zmmword ptr [rsi]')
