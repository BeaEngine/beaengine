...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmulhrsw ')
        assert_equal(myDisasm.infos.repr, 'vpmulhrsw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0xb)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmulhrsw ')
        assert_equal(myDisasm.infos.repr, 'vpmulhrsw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0xb)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmulhrsw ')
        assert_equal(myDisasm.infos.repr, 'vpmulhrsw zmm1, zmm15, zmmword ptr [rsi]')
