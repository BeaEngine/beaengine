...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpunpcklwd xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpcklwd ')
        assert_equal(myDisasm.instr.repr, 'vpunpcklwd ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpcklwd ')
        assert_equal(myDisasm.instr.repr, 'vpunpcklwd xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x61')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpcklwd ')
        assert_equal(myDisasm.instr.repr, 'vpunpcklwd ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x61')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpcklwd ')
        assert_equal(myDisasm.instr.repr, 'vpunpcklwd zmm1, zmm15, zmmword ptr [rsi]')
