...
class TestSuite:
    def test(self):
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x0f90)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'seto ')
        assert_equal(myDisasm.instr.repr, 'seto byte ptr [rax]')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0x0f90)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'seto ')
        assert_equal(myDisasm.instr.repr, 'seto al')
        ...
        assert_equal(myDisasm.instr.repr, 'kmovw k4, word ptr [r8]')
        ...
        assert_equal(myDisasm.instr.repr, 'kmovb k4, byte ptr [r8]')
        ...
        assert_equal(myDisasm.instr.repr, 'kmovq k4, qword ptr [r8]')
        ...
        assert_equal(myDisasm.instr.repr, 'kmovd k4, dword ptr [r8]')
