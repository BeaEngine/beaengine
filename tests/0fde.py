...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmaxub ')
        assert_equal(myDisasm.infos.repr, 'vpmaxub xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xde')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmaxub ')
        assert_equal(myDisasm.infos.repr, 'vpmaxub ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xde')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmaxub ')
        assert_equal(myDisasm.infos.repr, 'vpmaxub zmm1, zmm15, zmmword ptr [rsi]')
