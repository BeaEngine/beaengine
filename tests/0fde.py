...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpmaxub xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxub ')
        assert_equal(myDisasm.instr.repr, 'vpmaxub ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxub ')
        assert_equal(myDisasm.instr.repr, 'vpmaxub xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xde')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxub ')
        assert_equal(myDisasm.instr.repr, 'vpmaxub ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xde')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxub ')
        assert_equal(myDisasm.instr.repr, 'vpmaxub zmm1, zmm15, zmmword ptr [rsi]')
