...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vfnmadd213ps xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfnmadd213ps ')
        assert_equal(myDisasm.instr.repr, 'vfnmadd213ps ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfnmadd213ps ')
        assert_equal(myDisasm.instr.repr, 'vfnmadd213ps xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xac')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfnmadd213ps ')
        assert_equal(myDisasm.instr.repr, 'vfnmadd213ps ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xac')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfnmadd213ps ')
        assert_equal(myDisasm.instr.repr, 'vfnmadd213ps zmm1, zmm15, zmmword ptr [rsi]')
        ...
        assert_equal(myDisasm.instr.repr, 'vfnmadd213pd xmm9, xmm15, xmmword ptr [r14]')
