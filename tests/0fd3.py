...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsrlq ')
        assert_equal(myDisasm.infos.repr, 'vpsrlq xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xd3')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsrlq ')
        assert_equal(myDisasm.infos.repr, 'vpsrlq ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xd3')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsrlq ')
        assert_equal(myDisasm.infos.repr, 'vpsrlq zmm1, zmm15, zmmword ptr [rsi]')
