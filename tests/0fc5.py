...
class TestSuite:
    def test(self):
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Opcode, 0xfc5)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'pextrw ')
        assert_equal(myDisasm.instr.repr, 'pextrw ax, mm0, 22h')
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0xfc5)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'pextrw ')
        assert_equal(myDisasm.instr.repr, 'pextrw ax, xmm0, 22h')
        assert_equal(myDisasm.instr.Instruction.Immediat, 0x22)
        ...
        assert_equal(myDisasm.instr.Instruction.Opcode, 0xc5)
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpextrw ')
        assert_equal(myDisasm.instr.repr, 'vpextrw ax, xmm0, BBh')
