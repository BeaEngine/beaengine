...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vfmsub213ss xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmsub213ss ')
        assert_equal(myDisasm.instr.repr, 'vfmsub213ss ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmsub213ss ')
        assert_equal(myDisasm.instr.repr, 'vfmsub213ss xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xab')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmsub213ss ')
        assert_equal(myDisasm.instr.repr, 'vfmsub213ss ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xab')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vfmsub213ss ')
        assert_equal(myDisasm.instr.repr, 'vfmsub213ss zmm1, zmm15, zmmword ptr [rsi]')
