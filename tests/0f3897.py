...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsubadd132ps ')
        assert_equal(myDisasm.infos.repr, 'vfmsubadd132ps xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x97')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsubadd132ps ')
        assert_equal(myDisasm.infos.repr, 'vfmsubadd132ps ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x97')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsubadd132ps ')
        assert_equal(myDisasm.infos.repr, 'vfmsubadd132ps zmm1, zmm15, zmmword ptr [rsi]')
