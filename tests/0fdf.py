...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpandn xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpandn ')
        assert_equal(myDisasm.instr.repr, 'vpandn ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.repr, 'vpandnd xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xdf')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpandnd ')
        assert_equal(myDisasm.instr.repr, 'vpandnd ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xdf')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpandnd ')
        assert_equal(myDisasm.instr.repr, 'vpandnd zmm1, zmm15, zmmword ptr [rsi]')
