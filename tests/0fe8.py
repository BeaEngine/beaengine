...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubsb ')
        assert_equal(myDisasm.infos.repr, 'vpsubsb xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xe8')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubsb ')
        assert_equal(myDisasm.infos.repr, 'vpsubsb ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xe8')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsubsb ')
        assert_equal(myDisasm.infos.repr, 'vpsubsb zmm1, zmm15, zmmword ptr [rsi]')
