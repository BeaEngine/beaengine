...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsub132ss ')
        assert_equal(myDisasm.infos.repr, 'vfmsub132ss xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x9b')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsub132ss ')
        assert_equal(myDisasm.infos.repr, 'vfmsub132ss ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x9b')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsub132ss ')
        assert_equal(myDisasm.infos.repr, 'vfmsub132ss zmm1, zmm15, zmmword ptr [rsi]')
        ...
        assert_equal(myDisasm.infos.repr, 'v4fmaddss zmm1, zmm4...zmm7, xmmword ptr [rsi]')
