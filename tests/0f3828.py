...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpmuldq xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmuldq ')
        assert_equal(myDisasm.instr.repr, 'vpmuldq ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmuldq ')
        assert_equal(myDisasm.instr.repr, 'vpmuldq xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x28')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmuldq ')
        assert_equal(myDisasm.instr.repr, 'vpmuldq ymm1, ymm15, ymmword ptr [rsi]')
