...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpsubusw xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubusw ')
        assert_equal(myDisasm.instr.repr, 'vpsubusw ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubusw ')
        assert_equal(myDisasm.instr.repr, 'vpsubusw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xd9')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubusw ')
        assert_equal(myDisasm.instr.repr, 'vpsubusw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xd9')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpsubusw ')
        assert_equal(myDisasm.instr.repr, 'vpsubusw zmm1, zmm15, zmmword ptr [rsi]')
