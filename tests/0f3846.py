...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsravd ')
        assert_equal(myDisasm.infos.repr, 'vpsravd xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x46')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsravd ')
        assert_equal(myDisasm.infos.repr, 'vpsravd ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x46')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsravd ')
        assert_equal(myDisasm.infos.repr, 'vpsravd zmm1, zmm15, zmmword ptr [rsi]')
        ...
        assert_equal(myDisasm.infos.repr, 'vpsravq zmm1, zmm15, zmmword ptr [rsi]')
