...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpunpcklbw ')
        assert_equal(myDisasm.infos.repr, 'vpunpcklbw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x60')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpunpcklbw ')
        assert_equal(myDisasm.infos.repr, 'vpunpcklbw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x60')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpunpcklbw ')
        assert_equal(myDisasm.infos.repr, 'vpunpcklbw zmm1, zmm15, zmmword ptr [rsi]')
