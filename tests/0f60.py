...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpunpcklbw xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpcklbw ')
        assert_equal(myDisasm.instr.repr, 'vpunpcklbw ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpcklbw ')
        assert_equal(myDisasm.instr.repr, 'vpunpcklbw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x60')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpcklbw ')
        assert_equal(myDisasm.instr.repr, 'vpunpcklbw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x60')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpunpcklbw ')
        assert_equal(myDisasm.instr.repr, 'vpunpcklbw zmm1, zmm15, zmmword ptr [rsi]')
