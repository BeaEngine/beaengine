...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmadd213ss ')
        assert_equal(myDisasm.infos.repr, 'vfmadd213ss xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xa9')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmadd213ss ')
        assert_equal(myDisasm.infos.repr, 'vfmadd213ss ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xa9')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmadd213ss ')
        assert_equal(myDisasm.infos.repr, 'vfmadd213ss zmm1, zmm15, zmmword ptr [rsi]')
