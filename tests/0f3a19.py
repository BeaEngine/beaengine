...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(myDisasm.infos.repr, 'vextractf32x4 ymm4, ymm0, xmmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x19)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vextractf32x4 ')
        assert_equal(myDisasm.infos.repr, 'vextractf32x4 zmm4, zmm0, xmmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.infos.repr, 'vextractf64x2 ymm4, ymm0, xmmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x19)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vextractf64x2 ')
        assert_equal(myDisasm.infos.repr, 'vextractf64x2 zmm4, zmm0, xmmword ptr [rax], 11h')
