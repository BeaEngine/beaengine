...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpmaxsd xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxsd ')
        assert_equal(myDisasm.instr.repr, 'vpmaxsd ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxsd ')
        assert_equal(myDisasm.instr.repr, 'vpmaxsd xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x3d')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxsd ')
        assert_equal(myDisasm.instr.repr, 'vpmaxsd ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0x3d')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmaxsd ')
        assert_equal(myDisasm.instr.repr, 'vpmaxsd zmm1, zmm15, zmmword ptr [rsi]')
