...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.instr.repr, 'vpmulhw xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmulhw ')
        assert_equal(myDisasm.instr.repr, 'vpmulhw ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmulhw ')
        assert_equal(myDisasm.instr.repr, 'vpmulhw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xe5')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmulhw ')
        assert_equal(myDisasm.instr.repr, 'vpmulhw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.instr.Instruction.Opcode), '0xe5')
        assert_equal(myDisasm.instr.Instruction.Mnemonic, 'vpmulhw ')
        assert_equal(myDisasm.instr.repr, 'vpmulhw zmm1, zmm15, zmmword ptr [rsi]')
