...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmulhw ')
        assert_equal(myDisasm.infos.repr, 'vpmulhw xmm1, xmm15, xmmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xe5')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmulhw ')
        assert_equal(myDisasm.infos.repr, 'vpmulhw ymm1, ymm15, ymmword ptr [rsi]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xe5')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmulhw ')
        assert_equal(myDisasm.infos.repr, 'vpmulhw zmm1, zmm15, zmmword ptr [rsi]')
