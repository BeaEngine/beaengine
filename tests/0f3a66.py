...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(myDisasm.infos.repr, 'vfpclassps xmm4, xmm0, xmmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x66)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfpclassps ')
        assert_equal(myDisasm.infos.repr, 'vfpclassps ymm4, ymm0, ymmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x66)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfpclassps ')
        assert_equal(myDisasm.infos.repr, 'vfpclassps zmm4, zmm0, zmmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.infos.repr, 'vfpclasspd xmm4, xmm0, xmmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x66)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfpclasspd ')
        assert_equal(myDisasm.infos.repr, 'vfpclasspd ymm4, ymm0, ymmword ptr [rax], 11h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x66)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfpclasspd ')
        assert_equal(myDisasm.infos.repr, 'vfpclasspd zmm4, zmm0, zmmword ptr [rax], 11h')
