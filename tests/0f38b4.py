...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.repr, 'vpmadd52luq xmm1, xmm0, xmmword ptr [rsi]')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0xb4)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmadd52luq ')
        assert_equal(myDisasm.infos.repr, 'vpmadd52luq ymm1, ymm0, ymmword ptr [rsi]')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0xb4)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpmadd52luq ')
        assert_equal(myDisasm.infos.repr, 'vpmadd52luq zmm1, zmm0, zmmword ptr [rsi]')
