...
/* ========================================================================*/
 void (__bea_callspec__ *opcode_map3[])(PDISASM) = {
    ...
    vpshldvw_   , vpshldvd_   , vpshrdvw_    , vpshrdvd_    , FailDecode  , vpermi2b_   , vpermi2d_       , vpermi2ps_      , vpbroadcastb , vpbroadcastw , FailDecode   , FailDecode     , FailDecode    , FailDecode    , FailDecode    , FailDecode,
