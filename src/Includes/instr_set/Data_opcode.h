...
/* ========================================================================*/
 void (__bea_callspec__ *opcode_map3[])(PDISASM) = {
    ...
    vpscatterdd,vpscatterqd, FailDecode, FailDecode , FailDecode, FailDecode, vfmaddsub213ps_, vfmsubadd213ps_, vfmadd213ps_, vfmadd213ss_, vfmsub213ps_, vfmsub213ss_, vfnmadd213ps_, vfnmadd213ss_, vfnmsub213ps_, vfnmsub213ss_,
