...
/* ========================================================================*/
 void (__bea_callspec__ *opcode_map3[])(PDISASM) = {
    ...
    vpdpbusd_   , vpdpbusds_  , vpdpwssd_    , vpdpwssds_   , vpopcntb_   , vpopcntd_   , FailDecode      , FailDecode      , vpbroadcastd , vpbroadcastq ,vbroadcasti128, FailDecode   , FailDecode    , FailDecode    , FailDecode    , FailDecode,
