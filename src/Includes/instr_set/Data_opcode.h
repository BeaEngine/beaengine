...
/* ========================================================================*/
 void (__bea_callspec__ *opcode_map3[])(PDISASM) = {
    ...
    pblendvb_   , vpsravw_    , vpsllvw_     , vcvtph2ps_   , blendvps_   , blendvpd_   , vpermps_        , ptest_          , vbroadcastss , vbroadcastsd , FailDecode   , FailDecode   , pabsb_        , pabsw_        , pabsd_        , vpabsq_   ,
