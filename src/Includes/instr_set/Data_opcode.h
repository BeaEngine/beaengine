...
/* ==========================================================================*/
 void (__bea_callspec__ *opcode_map4[])(PDISASM) = {
    vpermq_   , vpermpd   , FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, roundps_  , roundpd_  , roundss_  , roundsd_  , blendps_  , blendpd_  , pblendw_  , palignr_  ,
