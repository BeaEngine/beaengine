...
/* ========================================================================*/
 void (__bea_callspec__ *opcode_map3[])(PDISASM) = {
    ...
    invept_     , invvpid_    , invpcid_     , vpmultishift , FailDecode  , FailDecode  , FailDecode      , FailDecode      , vexpandps    , vpexpandd    , vcompressps  , vpcompressd    , vpmaskmovd    , FailDecode    , vpmaskmovd2   , FailDecode    ,
