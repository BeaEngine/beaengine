...
/* ========================================================================*/
 void (__bea_callspec__ *opcode_map3[])(PDISASM) = {
    ...
    pblendvb_ , vpsravw_  , vpsllvw_  , FailDecode , blendvps_ , blendvpd_ , FailDecode, ptest_    , FailDecode, FailDecode, FailDecode, FailDecode, pabsb_    , pabsw_    , pabsd_    , FailDecode,
