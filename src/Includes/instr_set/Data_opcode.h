...
/* ========================================================================*/
 void (__bea_callspec__ *opcode_map3[])(PDISASM) = {
    ...
    pmulld_     , phminposuw_ , vgetexpps_   , vgetexpss_   , vplzcntd_   , psrlvd_     , psravd_         , psllvd_         , FailDecode   , FailDecode   , FailDecode   , FailDecode   , vrcp14ps_     , vrcp14ss_     , FailDecode    , FailDecode,
