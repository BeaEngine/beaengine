...
/* ========================================================================*/
 void (__bea_callspec__ *opcode_map3[])(PDISASM) = {
    ...
    pblendvb_ , vpsravw_  , vpsllvw_  , vcvtph2ps_ , blendvps_ , blendvpd_ , vpermps_  , ptest_    , FailDecode, FailDecode, FailDecode, FailDecode, pabsb_    , pabsw_    , pabsd_    , FailDecode,
    ...
    vpshldvw_ , vpshldvd_ , vpshrdvw_ , vpshrdvd_  , FailDecode, vpermi2b_ , vpermi2d_ , vpermi2ps_, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode,
    invept_   , invvpid_  , invpcid_  ,vpmultishift, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode,
    ...
    vpscatterdd,vpscatterqd,vpscatterdps, FailDecode , FailDecode, FailDecode, vfmaddsub213ps_, vfmsubadd213ps_, vfmadd213ps_, vfmadd213ss_, vfmsub213ps_, vfmsub213ss_, vfnmadd213ps_, vfnmadd213ss_, vfnmsub213ps_, vfnmsub213ss_,
...
/* ==========================================================================*/
 void (__bea_callspec__ *opcode_map4[])(PDISASM) = {
    ...
    FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode,
    dpps_     , dppd_     , mpsadbw_  , FailDecode, pclmulqdq_, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, blendvps_ , blendvpd_ , pblendvb_ , FailDecode, FailDecode, FailDecode,
    FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode, FailDecode,
